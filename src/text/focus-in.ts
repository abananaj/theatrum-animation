...
const focusIn: Record<string, AnimationConfig> = {
	...
	'focus-in-expand': {
		...
		from: { letterSpacing: '-0.5em', filter: 'blur(12px)', opacity: 0 },
	},
	'focus-in-contract': {
		...defaults,
		name: 'focus-in-contract',
		from: { letterSpacing: '1em', filter: 'blur(12px)', opacity: 0 },
	},
	'focus-in-contract-bck': {
		...defaults,
		name: 'focus-in-contract-bck',
		from: {
			letterSpacing: '1em',
			z: 300,
			filter: 'blur(12px)',
