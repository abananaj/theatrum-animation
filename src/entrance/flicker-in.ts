...
const flickerIn: Record<string, AnimationConfig> = {
	...
	'flicker-in-2': {
		...
		timeline: (el) => {
			...
			const s3 =
				'0 0 30px rgba(255,255,255,.55), 0 0 60px rgba(255,255,255,.3)';
			const s4 =
				'0 0 30px rgba(255,255,255,.55), 0 0 60px rgba(255,255,255,.3), 0 0 100px rgba(255,255,255,.1)';
			const s5 =
				'0 0 30px rgba(255,255,255,.6), 0 0 60px rgba(255,255,255,.4), 0 0 110px rgba(255,255,255,.2), 0 0 100px rgba(255,255,255,.1)';
			const s6 =
			...
			steps.forEach(([t, op, shadow]) =>
				tl.set(el, { opacity: op, boxShadow: shadow }, t)
			);
			return tl;
		},
	},
